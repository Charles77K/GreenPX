...
const HeroSection = () => {
  return (
    <m.div
      ...
      className="flex-col-center py-10 md:py-16 px-4 md:px-8 lg:px-12 relative"
    >
      {/* Background Image */}
      <Image
      ...
      <div className="flex relative flex-col items-center justify-center pt-20 text-white max-w-[1800px] mx-auto">
        <h1 className="text-6xl sm:text-7xl lg:text-8xl xl:text-[7rem] 2xl:text-[8rem] xl:-tracking-[6px] md:leading-none text-center font-thin">
          Do you have <br />
        ...
        {/* services */}
        <ul className="flex-center gap-2 md:gap-3 text-xs md:text-sm 2xl:text-lg  flex-wrap font-medium mt-4">
        ...
        >
          <div className="grid grid-cols-2 md:grid-cols-4 items-start gap-10 md:gap-10 xl:gap-20 p-4 md:p-6 rounded-2xl bg-transparent backdrop-blur-md max-w-screen-xl mx-auto">
